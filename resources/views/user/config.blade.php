            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="imagen_path" class="col-md-4 col-form-label text-md-right">Avatar</label>

                            <div class="col-md-6">
                                @include('includes.avatar');
                                <input id="imagen_path" type="file" class="form-control @error('imagen_path') is-invalid @enderror" name="imagen_path" value="{{ Auth::user()->email }}">
